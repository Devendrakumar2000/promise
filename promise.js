...
function example1(){
    ...
    console.log("example1 function");// in example1() func, log firstly executed by compiler. and then compiler go to next.
    after(); // here in example1() , we call the after() to execute. after() function only executed after the example1() is done. this is callback function
 }
 function after(){
     console.log("after example1 function executed");
 } 
 //example 2
 
 function a1(){
 
     console.log("function 1 executed.."); //here this log is first executed 
     setTimeout(function a2(){ //then function a2 is executed with setTimeout as 2 seconds. 
           console.log("function 2 executed.."); //after the 2 secoonds ,this function a2's log will be execute by function a1().
     },2000);
 };
